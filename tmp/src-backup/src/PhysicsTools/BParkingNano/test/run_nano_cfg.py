...
options.register('reportEvery', 2,
    VarParsing.multiplicity.singleton,
...
outputFileNANO = cms.untracked.string('_'.join(['TTToHadronic',
                                                ext1[options.lhcRun],
                                                ext2[options.isMC],
                                                options.tag])+'.root')
...
if not options.inputFiles:
    if options.lhcRun == 2:
        options.inputFiles = [
#'file:/t3home/gcelotto/BTV/genInclusiveSV/CMSSW_10_6_20/src/TRK-RunIISummer20UL18MiniAODv2-00016.root',
'/store/mc/RunIISummer20UL18MiniAODv2/TTToHadronic_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v16_L1v1-v1/00000/004EF875-ACBB-FE45-B86B-EAF83448CE62.root',
#'/store/mc/RunIISummer20UL18MiniAODv2/TTToHadronic_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v16_L1v1-v1/00000/0381415E-3E93-1546-835C-4C73CD974231.root'
...
if options.lhcRun == 2:
    process.nanoAOD_Jets_step = cms.Path(process.nanoSequence + process.nanoTracksSequence)
