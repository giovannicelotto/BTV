...
class CandMCMatchTableProducerBPark : public edm::global::EDProducer<> {
    public:
            ...
            candMap_(consumes<edm::Association<reco::GenParticleCollection>>(params.getParameter<edm::InputTag>("mcMap")))            
        {
            ...
            else if (type == "svDaughters") type_ = MsvDaughters;
	    ...
	    std::cout << "type = " << type << std::endl;
            switch(type_) { 
                ...
                case MsvDaughters: flavDoc_  = "1 = prompt, 511 = from B0, 521 = from B+/-, 0 = unknown or unmatched"; break;
    ...
    protected:
        ...
        enum MatchType { MMuon, MElectron, MTau, MPhoton, MTrack,MsvDaughters, MOther } type_;
        std::string flavDoc_;
};
